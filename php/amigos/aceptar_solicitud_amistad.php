<?php
	...
	$sql = "UPDATE amigos SET estado='1' WHERE (id_usuario1 = '$id_usuario' AND id_usuario2 = '$id_amigo') OR (id_usuario1 = '$id_amigo' AND id_usuario2 = '$id_usuario')";
	...
	$fecha = date("Y-m-d");
  	$hora = date('G:i:s');
  	$accion = "Has aceptado la solicitud de amistad de ".$amigo;

	$sql80 = "INSERT INTO historial (tipo,id_usuario,id_auxiliar,accion,fecha,hora,color) VALUES('8','$id_usuario','0','$accion','$fecha','$hora','verde');";
