<?php
	...
	$sql = "INSERT INTO votos_negativos (tipo,id_usuario,id_publicacion) VALUES('$tipo','$id_usuario','$id_publicacion');";
    ...
    while($row20 = $result20->fetch_assoc()){
	    ...
	    while($row30 = $result30->fetch_assoc()){
		    ...
		    if($tipo == '1') {
		    	...
		    	$accion = "No te ha gustado un trabalenguas de ".$amigo;
		    	$accion2 = "A ".$usuario_auxiliar." no le ha gustado un trabalenguas tuyo";
		    }

		    else if($tipo == '2') {

		    	$accion = "No te ha gustado un calambur de ".$amigo;
		    	$accion2 = "A ".$usuario_auxiliar." no le ha gustado un calambur tuyo";
		    }

		    else if($tipo == '3') {

		    	$accion = "No te ha gustado un criptograma de ".$amigo;
		    	$accion2 = "A ".$usuario_auxiliar." no le ha gustado un criptograma tuyo";
		    }

		    else if($tipo == '4') {

		    	$accion = "No te ha gustado un lipograma de ".$amigo;
		    	$accion2 = "A ".$usuario_auxiliar." le ha gustado un lipograma tuyo";
		    }

		    else if($tipo == '5') {

		    	$accion = "No te ha gustado un pangrama de ".$amigo;
		    	$accion2 = "A ".$usuario_auxiliar." le ha gustado un pangrama tuyo";
		    }
		    
		    else if($tipo == '6') {

		    	$accion = "No te ha gustado un palíndromo de ".$amigo;
		    	$accion2 = "A ".$usuario_auxiliar." le ha gustado un palíndromo tuyo";
		    }

		    $sql80 = "INSERT INTO historial (tipo,id_usuario,id_auxiliar,accion,fecha,hora,color) VALUES('16','$id_usuario','0','$accion','$fecha','$hora','rojo');";
		    ...
		    $sql81 = "INSERT INTO historial (tipo,id_usuario,id_auxiliar,accion,fecha,hora,color) VALUES('16','$id_amigo','0','$accion2','$fecha','$hora','rojo');";
