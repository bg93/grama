<?php
	...
	$sql = "DELETE FROM votos_negativos WHERE (id_publicacion = '$id_publicacion' AND id_usuario = '$id_usuario');";
    ...
    while($row20 = $result20->fetch_assoc()){
	    ...
	    while($row30 = $result30->fetch_assoc()){
		    ...
		    if($tipo == '1') {
		    	...
		    	$accion = "Ya no te disgusta un trabalenguas de ".$amigo;
		    }

		    else if($tipo == '2') {

		    	$accion = "Ya no te disgusta un calambur de ".$amigo;
		    }

		    else if($tipo == '3') {

		    	$accion = "Ya no te disgusta un criptograma de ".$amigo;
		    }

		    else if($tipo == '4') {

		    	$accion = "Ya no te disgusta un lipograma de ".$amigo;
		    }

		    else if($tipo == '5') {

		    	$accion = "Ya no te disgusta un pangrama de ".$amigo;
		    }
		    
		    else if($tipo == '6') {

		    	$accion = "Ya no te disgusta un palíndromo de ".$amigo;
		    }
