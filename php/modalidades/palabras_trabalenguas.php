<?php
	...
	//Variables POST
	$id_usuario = (isset($_POST['id-usuario-recursos-trabalenguas']) ? $_POST['id-usuario-recursos-trabalenguas'] : '');
    $cadena = (isset($_POST['cadena-recursos-trabalenguas']) ? $_POST['cadena-recursos-trabalenguas'] : '');
    $opcion = (isset($_POST['opcion-recursos-trabalenguas']) ? $_POST['opcion-recursos-trabalenguas'] : '');
