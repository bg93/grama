<?php
	...
	//Variables POST
	$id_usuario = (isset($_POST['id-usuario-creacion-calambures']) ? $_POST['id-usuario-creacion-calambures'] : '');
    $texto1 = (isset($_POST['texto1-creacion-calambures']) ? $_POST['texto1-creacion-calambures'] : '');
    $texto2 = (isset($_POST['texto2-creacion-calambures']) ? $_POST['texto2-creacion-calambures'] : '');
	...
	$accion = "Has creado un calambur [+ 3 PUNTOS]";
	...
	echo "1-Tu calambur se ha publicado correctamente.<br><br>Aparecerá disponible en el listado de publicaciones en el menor tiempo posible.";
