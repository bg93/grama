<?php
	...
	//Variables POST
	$id_usuario = (isset($_POST['id-usuario-recursos-pangramas']) ? $_POST['id-usuario-recursos-pangramas'] : '');
    $cadenas = (isset($_POST['cadena-recursos-pangramas']) ? $_POST['cadena-recursos-pangramas'] : '');
    $opcion = (isset($_POST['opcion-recursos-pangramas']) ? $_POST['opcion-recursos-pangramas'] : '');
