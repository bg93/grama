<?php
	...
	//Variables POST
	$id_usuario = (isset($_POST['id-usuario-creacion-pangramas']) ? $_POST['id-usuario-creacion-pangramas'] : '');
    $texto = (isset($_POST['texto-creacion-pangramas']) ? $_POST['texto-creacion-pangramas'] : '');
    $fecha = date("Y-m-d");
  	$hora = date('G:i:s');
  	$tipo = '5';
  	$valoracion = '0';
	...
	$accion = "Has creado un pangrama [+ 3 PUNTOS]";
	...
	echo "1-Tu pangrama se ha publicado correctamente.<br><br>Aparecerá disponible en el listado de publicaciones en el menor tiempo posible.";
